export const routeLoaders = {
  ...
  pendingEnrollmentsPage: () => import("../../features/enrollments/pages/PendingEnrollmentsPage"),
  studentsPage: () => import("../../features/students/pages/StudentsPage"),
  paymentLedgerPage: () => import("../../features/payments/pages/PaymentLedgerPage"),
  ...
  promoOffersPage: () => import("../../features/settings/pages/PromoOffersPage"),
...
const pathLoaderMap = {
  ...
  "/settings/promo-offers": routeLoaders.promoOffersPage,

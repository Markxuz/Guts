    ...
    <div className="rounded-xl border-t-2 border-t-[#800000] border-slate-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-slate-500">Schedule change requests awaiting admin review</p>
        </div>
      ...
      {!loading && rows.length === 0 ? (
        <p className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-4 text-sm text-slate-500">No pending schedule approvals.</p>
      ) : null}
